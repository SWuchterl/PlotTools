...
EXTRA_NAME=
SYST_DIR1=/eos/cms/store/cmst3/group/top/rsalvatico/Vcb_analysis_07042026_syst_2024_1L_Wcb/
...
python3 prepareHistosForCards.py --input_dirs $INPUT_DIR/mc/ --output_dir $OUTPUT_DIR --tree_name Events --year $YEAR --nproc 1 --extra_syst_dir $SYST_DIR1