...
OUTPUT_DIR=datacard_preparation_07042026_JME_onlySurvivingVeto/
YEAR=2024


python3 prepareHistosForCards.py --input_dirs $INPUT_DIR/data/ --output_dir $OUTPUT_DIR --tree_name Events --year $YEAR --nproc 1 
python3 prepareHistosForCards.py --input_dirs $INPUT_DIR/mc/ --output_dir $OUTPUT_DIR --tree_name Events --year $YEAR --nproc 1 --extra_syst_dir $SYST_DIR