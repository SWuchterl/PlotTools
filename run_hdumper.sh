...
python3 hdumperOptimized.py --input_dirs /eos/cms/store/cmst3/group/top/rsalvatico/Vcb_analysis_17092025_2024_1L_Wcb/mc/ --output_dir histos_01102025_test/  --tree_name Events --input_csv configs/hconfig.csv --year 2024 --use5FS
python3 hdumperOptimized.py --input_dirs /eos/cms/store/cmst3/group/top/rsalvatico/Vcb_analysis_17092025_2024_1L_Wcb/data/ --output_dir histos_01102025_test/  --tree_name Events --input_csv configs/hconfig.csv --year 2024 --use5FS

# Select ttLF < 0.1 and ttWcb > 0.6
#python3 hdumper.py --input_dirs /eos/cms/store/cmst3/group/top/rsalvatico/29012025_2018_1L/mc/ --output_dir histos_07072025/scores_ttLFm0p1_ttWcbM0p6/  --tree_name Events --input_csv configs/hconfig_minimal.csv --year 2018 --add_selection "score_ttLF < 0.1 && score_tt_Wcb > 0.6"
