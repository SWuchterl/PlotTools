...
python3 hdumper.py --input_dirs /eos/cms/store/cmst3/group/top/rsalvatico/Vcb_analysis_17092025_2024_1L_Wcb/mc/ --output_dir histos_01102025_test/  --tree_name Events --input_csv configs/hconfig.csv --year 2024 --use5FS
python3 hdumper.py --input_dirs /eos/cms/store/cmst3/group/top/rsalvatico/Vcb_analysis_17092025_2024_1L_Wcb/data/ --output_dir histos_01102025_test/  --tree_name Events --input_csv configs/hconfig.csv --year 2024 --use5FS
