#!/bin/sh
# Preselection scores
python3 plotter.py --input_dir histos_07072025/scores/ --output_dir plots_07072025/preselection_scores/ --sig_norm 100 --input_csv configs/hconfig_scores.csv --blind --log
